...
data merge block 0 0 0 {Text1:'{"translate":"display.map.damage_dealt","with":[{"score":{"name":"s.damage","objective":"map.d"},"font":"map:numbers"},{"text":"\\u0015","font":"map:main","color":"#FFF700"}]}'}
