...
execute as @e[type=#map:mobs,tag=map.entity.mob,dx=0,limit=1,sort=nearest] positioned ~-0.89 ~-0.89 ~-0.89 if entity @s[dx=0] at @s run function map:entity/technical/projectile/hit
