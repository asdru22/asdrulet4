...
data merge block 0 0 0 {Text1:'{"translate":"display.map.damage_recived","with":[{"translate":"space.-max"},{"text":"-","font":"map:numbers"},{"score":{"name":"d.1","objective":"map.d"},"font":"map:numbers"},{"text":"❤","color":"dark_purple"},{"translate":"space.-max"}]}'}
