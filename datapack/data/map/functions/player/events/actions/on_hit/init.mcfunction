...
data modify storage mdata root.core.player_hit_mob.SelectedItem set from entity @s SelectedItem
data modify storage mdata root.core.player_hit_mob.Inventory set from entity @s Inventory
