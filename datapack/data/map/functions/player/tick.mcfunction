...
execute if entity @s[scores={use_coas=1..}] run function map:player/events/on_used_item/carrot_on_a_stick/main
execute if entity @s[scores={use_wfoas=1..}] run function map:player/events/on_used_item/warped_fungus_on_a_stick/main