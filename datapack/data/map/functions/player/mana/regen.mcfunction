...
scoreboard players operation d.2 map.d = @s stat.mana
scoreboard players operation d.3 map.d = @s stat.mana
scoreboard players operation d.2 map.d /= const.10 map.d
scoreboard players operation d.3 map.d %= const.10 map.d

scoreboard players operation d.4 map.d = @s max_mana
scoreboard players operation d.5 map.d = @s max_mana
