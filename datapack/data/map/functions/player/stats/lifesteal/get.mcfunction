...
#acc 1
execute store result score d.0 map.d run data get storage mdata root.temp.equipment.Accessories[0].tag.base.stats.lifesteal 
execute if score @s map.level >= lvl.acc1 map.d run scoreboard players operation s.lifesteal map.d += d.0 map.d
#acc 2
execute store result score d.0 map.d run data get storage mdata root.temp.equipment.Accessories[1].tag.base.stats.lifesteal 
execute if score @s map.level >= lvl.acc2 map.d run scoreboard players operation s.lifesteal map.d += d.0 map.d
#acc 3
execute store result score d.0 map.d run data get storage mdata root.temp.equipment.Accessories[2].tag.base.stats.lifesteal 
