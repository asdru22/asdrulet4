...
execute if score d.1 map.d matches 1.. if score .hit map.d matches 1 positioned ^ ^ ^.33 if block ~ ~ ~ #map:passable run function map:item/magic/item/light_stave/cast