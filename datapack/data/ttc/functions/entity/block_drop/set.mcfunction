...
execute if data storage ttc:mdata root.temp.block_broken{id:"minecraft:deepslate_diamond_ore"} run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:repeating_command_block",Count:1b,tag:{CustomModelData:2}}]}
