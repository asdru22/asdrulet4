...
data merge block 0 0 0 {Text1:'{"translate":"display.ttc.damage_dealt","with":[{"score":{"name":"s.damage","objective":"ttc.d"},"font":"ttc:numbers"},{"text":"\\u0015","font":"ttc:main","color":"#FFF700"}]}'}
