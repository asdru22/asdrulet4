...
data merge block 0 0 0 {Text1:'{"translate":"display.ttc.damage_recived","with":[{"translate":"space.-max"},{"text":"-"},{"score":{"name":"d.1","objective":"ttc.d"}},{"text":"\\u0032","color":"white","font":"ttc:main"},{"translate":"space.-max"}]}'}
