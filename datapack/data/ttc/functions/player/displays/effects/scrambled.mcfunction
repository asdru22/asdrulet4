...
data merge block 0 0 0 {Text1:'{"translate":"display.ttc.damage_recived","with":[{"translate":"space.-max"},{"text":"-"},{"score":{"name":"d.1","objective":"ttc.d"}},{"text":"❤","color":"dark_purple"},{"translate":"space.-max"}]}'}
