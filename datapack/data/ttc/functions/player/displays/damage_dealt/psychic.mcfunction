...
###
data merge block 0 0 0 {Text1:'{"translate":"display.ttc.damage_dealt","with":[{"translate":"space.-max"},{"score":{"name":"psychic.dmg","objective":"ttc.d"},"font":"ttc:numbers"},{"text":"❁","color":"light_purple"},{"translate":"space.-max"}]}'}
