...
#get chest item
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.chest.tag.base.stats.mana_regen 
execute if score @s ttc.level >= lvl.chest ttc.d run scoreboard players operation s.mana_regen ttc.d += d.0 ttc.d
#get legs item
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.legs.tag.base.stats.mana_regen 
execute if score @s ttc.level >= lvl.legs ttc.d run scoreboard players operation s.mana_regen ttc.d += d.0 ttc.d
#get feet item
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.feet.tag.base.stats.mana_regen 
execute if score @s ttc.level >= lvl.feet ttc.d run scoreboard players operation s.mana_regen ttc.d += d.0 ttc.d
#acc 1
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.Accessories[0].tag.base.stats.mana_regen 
execute if score @s ttc.level >= lvl.acc1 ttc.d run scoreboard players operation s.mana_regen ttc.d += d.0 ttc.d
#acc 2
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.Accessories[1].tag.base.stats.mana_regen 
execute if score @s ttc.level >= lvl.acc2 ttc.d run scoreboard players operation s.mana_regen ttc.d += d.0 ttc.d
#acc 3
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.Accessories[2].tag.base.stats.mana_regen 
