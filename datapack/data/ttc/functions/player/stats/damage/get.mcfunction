...
#get chest item
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.chest.tag.base.stats.damage 
execute if score @s ttc.level >= lvl.chest ttc.d run scoreboard players operation s.damage ttc.d += d.0 ttc.d
#get legs item
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.legs.tag.base.stats.damage 
execute if score @s ttc.level >= lvl.legs ttc.d run scoreboard players operation s.damage ttc.d += d.0 ttc.d
#get feet item
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.feet.tag.base.stats.damage 
execute if score @s ttc.level >= lvl.feet ttc.d run scoreboard players operation s.damage ttc.d += d.0 ttc.d
#acc 1
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.Accessories[0].tag.base.stats.damage 
execute if score @s ttc.level >= lvl.acc1 ttc.d run scoreboard players operation s.damage ttc.d += d.0 ttc.d
#acc 2
execute store result score d.0 ttc.d run data get storage ttc:data root.temp.equipment.Accessories[1].tag.base.stats.damage 
...
#execute if data storage ttc:data root.temp.attack.type{type:"magic"} run scoreboard players operation s.damage ttc.d /= const.3 ttc.d
