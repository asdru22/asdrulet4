...
int main() {
    ...
    int damage_reduction = 0, level_req, damage, mining_speed = 0, arrow_speed = 0, crit_damage, crit_chance, mana_req = 0, lifesteal, max_mana, mana_regen, max_psychosis, durability = 0, psychosis_used = 0, health, hp_regen, defense, dodge_chance, ability_cooldown;
    ...
    if (lore_lines >= 1) {
      //--------------------- ABILITY COOLDOWN
      cout << "Define item cooldown (in seconds): ";
      cin >> ability_cooldown;
    }
    //--------------------- SELL PRICE
    int sell_price;
    ...
    if (ability_cooldown > 0) cout << ",ability_cooldown:" << 2*ability_cooldown;
    ...
    if (type != "material") {
      // display:damage
      if (damage != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.damage\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (damage > 0) cout << "";
        cout << damage << "\\\",\\\"color\\\":\\\"red\\\"}]}',";
      }
      // display: mana required
      if (mana_req != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.mana_req\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (mana_req > 0) cout << "";
        cout << mana_req << "\\\",\\\"color\\\":\\\"aqua\\\"}]}',";
      }
      // display:attack speed
      if (attack_speed != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.attack_speed\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (attack_speed > 0) cout << "";
        cout << attack_speed * 100 << "\\\",\\\"color\\\":\\\"yellow\\\"}]}',";
      }
      // display:arrow speed
      if (arrow_speed != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.arrow_speed\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (arrow_speed > 0) cout << "";
        cout << arrow_speed << "\\\",\\\"color\\\":\\\"yellow\\\"}]}',";
      }
      // display: crit chance
      if (crit_chance != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.crit_chance\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (crit_chance > 0) cout << "";
        cout << crit_chance << "\\\",\\\"color\\\":\\\"gold\\\"}]}',";
      }
      // display:crit damage
      if (crit_damage != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.crit_damage\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (crit_damage > 0) cout << "";
        cout << crit_damage << "\\\",\\\"color\\\":\\\"gold\\\"}]}',";
      }
      // display:lifesteal
      if (lifesteal != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.lifesteal\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (lifesteal > 0) cout << "";
        cout << lifesteal << "\\\",\\\"color\\\":\\\"dark_red\\\"}]}',";
      }
      // display:mining speed
      if (mining_speed != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.mining_speed\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (mining_speed > 0) cout << "";
        cout << mining_speed << "\\\",\\\"color\\\":\\\"yellow\\\"}]}',";
      }
      // display:psychosis req
      if (psychosis_used != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.psychosis_used\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (psychosis_used > 0) cout << "";
        cout << psychosis_used << "\\\",\\\"color\\\":\\\"light_purple\\\"}]}',";
      }
      // display: health 
      if (health != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.health\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (health > 0) cout << "";
        cout << health << "\\\",\\\"color\\\":\\\"green\\\"}]}',";
      }
      // display: hp regen 
      if (hp_regen != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.hp_regen\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (hp_regen > 0) cout << "";
        cout << hp_regen << "\\\",\\\"color\\\":\\\"green\\\"}]}',";
      }
      // display: defense 
      if (defense != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.defense\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (defense > 0) cout << "";
        cout << defense << "\\\",\\\"color\\\":\\\"green\\\"}]}',";
      }
      // display: damage_reduction 
      if (damage_reduction != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.damage_reduction\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (damage_reduction > 0) cout << "";
        cout << damage_reduction << "\\\",\\\"color\\\":\\\"green\\\"}]}',";
      }
      // display: max mana 
      if (max_mana != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.max_mana\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (max_mana > 0) cout << "";
        cout << max_mana << "\\\",\\\"color\\\":\\\"aqua\\\"}]}',";
      }
      // display: mana_regen 
      if (mana_regen != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.mana_regen\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (mana_regen > 0) cout << "";
        cout << mana_regen << "\\\",\\\"color\\\":\\\"aqua\\\"}]}',";
      }
      // display: max psychosis 
      if (max_psychosis != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.max_psychosis\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (max_psychosis > 0) cout << "";
        cout << max_psychosis << "\\\",\\\"color\\\":\\\"light_purple\\\"}]}',";
      }
      // display: dodge chance 
      if (dodge_chance != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.dodge_chance\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (dodge_chance > 0) cout << "";
        cout << dodge_chance << "\\\",\\\"color\\\":\\\"white\\\"}]}',";
      }
      // display: knockback resistance
      if (knockback_resistance != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.knockback_resistance\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (knockback_resistance > 0) cout << "";
        cout << knockback_resistance << "%" << "\\\",\\\"color\\\":\\\"dark_purple\\\"}]}',";
      }
      // display: movement_speed
      if (movement_speed != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.movement_speed\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (movement_speed > 0) cout << "";
        cout << movement_speed * 100 << "\\\",\\\"color\\\":\\\"yellow\\\"}]}',";
      }
      // display: luck
      if (luck != 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.luck\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        if (luck > 0) cout << "";
        cout << luck << "\\\",\\\"color\\\":\\\"dark_green\\\"}]}',";
      }
    }
    // display:ability
    if (lore_lines > 0) {
      ...
      if (ability_cooldown > 0) {
        cout << "'{\\\"translate\\\":\\\"item." << using_nspace << ".lore.ability.cooldown\\\",\\\"italic\\\":false,\\\"color\\\":\\\"gray\\\",\\\"with\\\":[{\\\"text\\\":\\\"";
        cout << 2*ability_cooldown << "\\\",\\\"color\\\":\\\"gold\\\"}]}',";
      }
      // display:sell price
      if (sell_price > 0)
        if (level_req > 0) {
