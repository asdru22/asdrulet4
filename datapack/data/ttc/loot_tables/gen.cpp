...
int main() {
	...
	int damage_reduction=0,level_req,damage,mining_speed=0, arrow_speed = 0, crit_damage, crit_chance, mana_req = 0, lifesteal, max_mana, mana_regen, max_psychosis, psychosis_used=0,health,hp_regen,defense,dodge_chance;
	...
	if (type == "tool"||type=="accessory") cout << ",Enchantments:[{id:\\\"minecraft:efficiency\\\",lvl:100s}],CanDestroy:[\\\"#map:tool_breakable/" << tool_type << "\\\"]";
